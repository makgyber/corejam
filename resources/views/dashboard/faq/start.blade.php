...
<ol>
    <li>
        Complete the profile information on your Profile page. <a href="{{route('profile.edit')}}" class="btn btn-sm btn-light">Edit profile</a>

    </li>
    <li>
        After providing the required data, you need to register your church in the system. 
    ...
    <li>Once you have at least one affiliation registered, you can now input members for that organisation.  
        <a href="{{route('affiliations.create')}}" class="btn btn-sm btn-light">Go to Members Registry</a>

    </li>
    <li>As a coordinator, you will also need to record your Target Outcomes to the system.
        <a href="{{route('affiliations.create')}}" class="btn btn-sm btn-light">Add Target Outcome</a>
